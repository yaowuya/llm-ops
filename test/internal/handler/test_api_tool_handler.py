...
openapi_schema_string = """{"server": "https://baidu.com", "description": "123",
"paths": {"/location": {"get": {"description": "获取本地位置", "operationId":"xxx",
"parameters":[{"name":"location", "in":"query", "description":"参数描述", "required":true,
"type":"str"}]}}}}"""
...
class TestApiToolHandler:
    ...
    @pytest.mark.parametrize(
        "provider_id", ["3944eee4-9d5a-4ca5-91c1-e56654cbc1e4", "3944eee4-9d5a-4ca5-91c1-e56654cbc1e5"]
    )
    ...
    def test_create_api_tool_provider(self, client, db):
        data = {
            ...
            "openapi_schema": '{"description":"查询ip所在地、天气预报、路线规划等高德工具包",'
            '"server":"https://gaode.example.com",'
            '"paths":{"/weather":{"get":'
            '{"description":"根据传递的城市名获取指定城市的天气预报，例如：广州",'
            '"operationId":"GetCurrentWeather",'
            '"parameters":[{"name":"location","in":"query",'
            '"description":"需要查询天气预报的城市名",'
            '"required":true,"type":"str"}]}},'
            '"/ip":{"post":{"description":"根据传递的ip查询ip归属地",'
            '"operationId":"GetCurrentIp",'
            '"parameters":[{"name":"ip","in":"request_body",'
    ...
    def test_update_api_tool_provider(self, client, db):
        ...
        data = {
            ...
            "openapi_schema": '{"description":"查询ip所在地、天气预报、路线规划等高德工具包",'
            '"server":"https://gaode.example.com",'
            '"paths":{"/weather":{"get":{"description":'
            '"根据传递的城市名获取指定城市的天气预报，例如：广州",'
            '"operationId":"GetCurrentWeather",'
            '"parameters":[{"name":"location","in":"query",'
            '"description":"需要查询天气预报的城市名",'
            '"required":true,"type":"str"}]}},'
