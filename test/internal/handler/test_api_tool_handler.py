    ...
    "paths": {
        "/location": {
            "get": {
                ...
                "operationId": "xxx",
                "parameters": [
                    {"name": "location", "in": "query", "description": "参数描述", "required": True, "type": "str"}
                ],
            }
        }
    },
...
class TestApiToolHandler:
    ...
    @pytest.mark.parametrize("openapi_schema", ["123", openapi_schema_dict])
    def test_validate_openapi_schema(self, openapi_schema, client):
        ...
        elif openapi_schema == openapi_schema_dict:
